...
final class RefreshTokenIdTest extends TestCase
{
    ...
    {
        $id1 = RefreshTokenId::generate();
        $id2 = RefreshTokenId::generate();
        $this->assertNotEquals($id1->value(), $id2->value());
    }

    public function test_creates_from_valid_string(): void
    {
        $id = RefreshTokenId::fromString('018e8f2a-1234-7000-8000-000000000001');
    ...
    public function test_throws_on_invalid_string(): void
    {
        ...
        RefreshTokenId::fromString('not-a-uuid');
    }

    public function test_equality(): void
    {
        $id1 = RefreshTokenId::fromString('018e8f2a-1234-7000-8000-000000000001');
        $id2 = RefreshTokenId::fromString('018e8f2a-1234-7000-8000-000000000001');
